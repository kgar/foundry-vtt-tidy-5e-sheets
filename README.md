...
> [!IMPORTANT]
> **Tidy 5e Sheets version 2 (dnd5e 3.0.x) is almost here!**
>
> The Tidy 5e Sheets rewrite is almost ready for dnd5e 3.0.x. Soon, all development efforts will now continue in step with the default sheets.
