...
> [!IMPORTANT]
> **Tidy 5e Sheets version 7 (dnd5e 4.1.x) is here!**
>
> The Tidy 5e Sheets rewrite is now compatible with dnd5e 4.1.x. All development efforts will continue in step with the current version of the default sheets.
