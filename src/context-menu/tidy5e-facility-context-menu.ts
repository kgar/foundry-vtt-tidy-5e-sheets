...
const OccupantLabelsByProp: Record<string, string> = {
  ...
  'system.trade.creatures': 'TIDY5E.FACILITY.Creatures.Label',
};
  ...
  let contextOptions: ContextMenuEntry[] = [
    ...
    },
    {
      label: brokenLink
        ...
        : FoundryAdapter.localize('TIDY5E.FACILITY.Action.RemoveOccupant', {
            facilityName,
          }),
