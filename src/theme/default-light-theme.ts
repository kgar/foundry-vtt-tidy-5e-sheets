...
export const defaultLightTheme: Tidy5eTheme = {
  ...
  variables: {
    ...
    '--t5ek-exhaustion-severity1-color': 'var(--t5ek-icon-font-color)',
    ...
    '--t5ek-table-header-row-color': 'var(--t5ek-faint-color)',
    '--t5ek-table-header-row-border-color': 'var(--t5ek-light-color)',
