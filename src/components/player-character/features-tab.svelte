<script lang="ts">
  ...
  const featureSections = Object.values<any>(context.features);
...
<div class="features list-layout">
  ...
  >
    ...
    <ul class="tidy5e-item-list">
      {#each backgroundSection.items as item}
          ...
          <div class="info-card" data-item-id={item._id}>
            ...
            <div class="description-wrap">
              <div class="info-card-description">
                {@html item.getChatData({ secrets: context.actor.isOwner })}
              </div>
            </div>
      ...
      {#if context.owner && allowEdit}
        <li class="items-footer">
          <a
            ...
            role="button"
            {...mapDatasetToDataAttributes(backgroundSection.dataset)}
          >
