...
>
  <div class="form-group">
    <article title={localize('DND5E.Senses')}>
      ...
      <ul class="traits-list">
        {#each Object.entries(context.senses) as [key, value]}
          <li class="tag {key}">{value}</li>
        {/each}
      </ul>
    </article>
    <a
      class="configure-senses"
      title={localize('DND5E.SensesConfig')}
      tabindex="0"
      role="button"
    >
  ...
  <div class="form-group {context.traits?.traits?.languages?.cssClass ?? ''}">
    <article title={localize('DND5E.Languages')}>
      ...
      <ul class="traits-list">
        {#each Object.entries(context.traits?.traits?.languages?.selected) as [key, value]}
          <li class="tag {key}">{value}</li>
        {/each}
      </ul>
    </article>
    <a
      class="configure-languages"
  ...
  <div class="form-group {context.traits.traits?.di?.cssClass ?? ''}}">
    <article title={localize('DND5E.DamImm')}>
      ...
      <ul class="traits-list">
        {#each Object.entries(context.traits.traits.di.selected) as [key, value]}
          <li class="tag {key}">{value}</li>
        {/each}
      </ul>
    </article>
    <a
      class="configure-damage-immunities"
      title={localize('DND5E.TraitConfig', { trait: localize('DND5E.DamImm') })}
      tabindex="0"
    >
      <i class="fas fa-pencil-alt" />
    </a>
  ...
  <div class="form-group {context.traits.traits?.dr?.cssClass ?? ''}">
    <article title={localize('DND5E.DamRes')}>
      ...
      <ul class="traits-list">
        {#each Object.entries(context.traits.traits.dr.selected) as [key, value]}
          <li class="tag {key}">{value}</li>
        {/each}
      </ul>
    </article>
    <a
      class="configure-damage-resistance"
      title={localize('DND5E.TraitConfig', { trait: localize('DND5E.DamRes') })}
      tabindex="0"
    >
      <i class="fas fa-pencil-alt" />
    </a>
  ...
  <div class="form-group {context.traits.traits?.dv?.cssClass ?? ''}">
    <article title={localize('DND5E.DamVuln')}>
      ...
      <ul class="traits-list">
        {#each Object.entries(context.traits.traits.dv.selected) as [key, value]}
          <li class="tag {key}">{value}</li>
        {/each}
      </ul>
    </article>
    <a
      class="configure-damage-vulnerabilities"
      title={localize('DND5E.TraitConfig', {
  ...
  <div class="form-group {context.traits.traits?.ci?.cssClass ?? ''}">
    <article title={localize('DND5E.ConImm')}>
      ...
      <ul class="traits-list">
        {#each Object.entries(context.traits.traits.ci.selected) as [key, value]}
          <li class="tag {key}">{value}</li>
        {/each}
      </ul>
    </article>
    <a
      class="configure-condition-immunity"
  ...
  <div class="form-group {context.traits.traits?.weaponProf?.cssClass ?? ''}">
...
c28,32.6,51.5,72.7,62,91.7c2.8,5,9.9,5.1,12.8,0.2c14-23.3,44.3-83.4,44.3-166.9C491,64.9,455.7,16.4,443.7,2.6z"
      ...
      <ul class="traits-list">
        {#each Object.entries(context.traits.traits.weaponProf.selected) as [key, value]}
          <li class="tag {key}">{value}</li>
        {/each}
      </ul>
    </article>
    <a
      class="configure-weapon-proficiency"
      data-trait="weapon"
      title={localize('DND5E.TraitConfig', {
  ...
  <div class="form-group {context.traits.traits?.armorProf?.cssClass ?? ''}}">
    <article title={localize('DND5E.TraitArmorProf')}>
      ...
      <ul class="traits-list">
        {#each Object.entries(context.traits.traits.armorProf.selected) as [key, value]}
          <li class="tag {key}">{value}</li>
        {/each}
      </ul>
    </article>
    <a
      class="configure-armor-proficiency"
      data-trait="armor"
      title={localize('DND5E.TraitConfig', {
  ...
  <div class="form-group {context.traits.traits?.toolProf?.cssClass ?? ''}}">
    <article title={localize('DND5E.TraitToolProf')}>
      ...
      <ul class="traits-list">
        {#each Object.entries(context.tools) as [key, tool]}
          <li
            class="tag tool proficiency-row"
            data-property="tools"
            data-key={key}
          >
            <input
              type="hidden"
              name="system.tools.{key}.value"
              value={tool.value.baseValue}
              data-dtype="Number"
            />
            <input
              type="hidden"
              name="system.tools.{key}.ability"
              value={tool.value.ability}
            />
            <a
              class="proficiency-toggle tool-proficiency"
              data-tooltip={tool.value.hover}>{@html tool.icon}</a
            >
            <h4 class="tool-name rollable">{tool.label}</h4>
            <a
              class="config-button"
              data-action="tool"
    ...
    <a
      class="configure-tool-proficiency"
      data-trait="tool"
      title={localize('DND5E.TraitConfig', {
