<script lang="ts">
  ...
  import ItemEditControl from '../../../components/items/ItemEditControl.svelte';
  import ItemDuplicateControl from '../../../components/items/ItemDuplicateControl.svelte';
  import ItemDeleteControl from '../../../components/items/ItemDeleteControl.svelte';
  ...
  import ItemFavoriteControl from '../../../components/items/ItemFavoriteControl.svelte';
