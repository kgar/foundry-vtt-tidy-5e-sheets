<div class="item-image-border">
  ...
  >
    <path
      d="M111.5 98.5V7.5L105 1H102"
      stroke="var(--filigree-border-color, var(--t5e-color-gold))"
    />
    <path
      d="M0.5 98.5V7.5L7 1H10"
      stroke="var(--filigree-border-color, var(--t5e-color-gold))"
    />
    <path
      d="M0.500009 8.5L0.500001 99.5L7 106L10 106"
      stroke="var(--filigree-border-color, var(--t5e-color-gold))"
    />
    <path
      d="M111.5 8.5L111.5 99.5L105 106L102 106"
      stroke="var(--filigree-border-color, var(--t5e-color-gold))"
    />
    <path
    ...
    />
    <path
      d="M10.5 1C6.5 4 1.5 2.5 1.5 2.5C1.5 2.5 2.5 5 2.5 10"
      stroke="var(--filigree-border-color, var(--t5e-color-gold))"
    />
    <path
