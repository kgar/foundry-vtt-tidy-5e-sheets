...
export const CONSTANTS = {
  ...
  COLUMN_SPEC_SECTION_KEY_DEFAULT:
    'tidy5eDefault',
  COLUMN_SPEC_TAB_KEY_DEFAULT: 'tidy5eDefault',
  COLUMN_SPEC_TYPE_KEY_DEFAULT: 'tidy5eDefault',
  ...
  TAB_VEHICLE_CARGO_LEGACY: 'cargo',
  ...
  PARTITION_MODULE_DEFAULT: 'tidy5eDefault',
