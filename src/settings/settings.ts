  ...
  return {
    ...
    settings: {
      ...
      hpOverlayBorder: {
        options: {
          name: `${FoundryAdapter.localize(
            'T5EK.Settings.HpOverlayBorder.name'
          )}`,
        ...
        get() {
          return FoundryAdapter.getGameSetting<number>('hpOverlayBorder');
        },
      },
      ...
      hpOverlayBorderNpc: {
        ...
        get() {
          return FoundryAdapter.getGameSetting<number>('hpOverlayBorderNpc');
        },
      },
