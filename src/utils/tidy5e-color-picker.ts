...
export function applyColorPickerCustomization(html) {
  if (game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerEnabled')) {
    ...
    const vColorPickerEquipped = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerEquipped'),
      0.3
    );
    ...
    const vColorPickerPrepared = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerPrepared'),
      0.3
    );
    ...
    const vColorPickerPact = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerPact'),
      0.3
    );
    const vColorPickerPactOutline = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerPactOutline')
    );
    const vColorPickerPactAccent = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerPactAccent')
    );
    const vColorPickerAtWill = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerAtWill'),
      0.3
    );
    const vColorPickerAtWillOutline = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerAtWillOutline')
    );
    const vColorPickerAtWillAccent = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerAtWillAccent')
    );
    const vColorPickerInnate = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerInnate'),
      0.3
    );
    const vColorPickerInnateOutline = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerInnateOutline')
    );
    const vColorPickerInnateAccent = HexToRGBA(
      game.settings.get(CONSTANTS.MODULE_ID, 'colorPickerInnateAccent')
    );
      ...
      .each(function (index, element) {
        ...
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_equipped,
                vColorPickerEquipped
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_equipped,
                vColorPickerEquipped
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.equipped')
      .each(function (index, element) {
        ...
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_equipped_outline,
                vColorPickerEquippedOutline
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_equipped_outline,
                vColorPickerEquippedOutline
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.equipped .item-image')
      .each(function (index, element) {
        const curValue = $(element).css(`-webkit-box-shadow`);
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_equipped_accent,
                vColorPickerEquippedAccent
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_equipped_accent,
                vColorPickerEquippedAccent
              );
      ...
      .each(function (index, element) {
        ...
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_prepared,
                vColorPickerPrepared
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_prepared,
                vColorPickerPrepared
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.prepared')
      .each(function (index, element) {
        ...
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_prepared_outline,
                vColorPickerPreparedOutline
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_prepared_outline,
                vColorPickerPreparedOutline
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.prepared .item-image')
      .each(function (index, element) {
        const curValue = $(element).css(`-webkit-box-shadow`);
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_prepared_accent,
                vColorPickerPreparedAccent
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_prepared_accent,
                vColorPickerPreparedAccent
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.pact')
      .each(function (index, element) {
        const curValue = $(element).css(`-webkit-box-shadow`);
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_pact_outline,
                vColorPickerPactOutline
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_pact_outline,
                vColorPickerPactOutline
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.pact .item-image')
      .each(function (index, element) {
        const curValue = $(element).css(`-webkit-box-shadow`);
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_pact_accent,
                vColorPickerPactAccent
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_pact_accent,
                vColorPickerPactAccent
              );
      ...
      .each(function (index, element) {
        ...
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_atwill,
                vColorPickerAtWill
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_atwill,
                vColorPickerAtWill
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.atwill')
      .each(function (index, element) {
        const curValue = $(element).css(`-webkit-box-shadow`);
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_atwill_outline,
                vColorPickerAtWillOutline
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_atwill_outline,
                vColorPickerAtWillOutline
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.atwill .item-image')
      .each(function (index, element) {
        const curValue = $(element).css(`-webkit-box-shadow`);
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_atwill_accent,
                vColorPickerAtWillAccent
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_atwill_accent,
                vColorPickerAtWillAccent
              );
      ...
      .each(function (index, element) {
        ...
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_innate,
                vColorPickerInnate
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_innate,
                vColorPickerInnate
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.innate')
      .each(function (index, element) {
        const curValue = $(element).css(`-webkit-box-shadow`);
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_innate_outline,
                vColorPickerInnateOutline
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_innate_outline,
                vColorPickerInnateOutline
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.innate .item-image')
      .each(function (index, element) {
        const curValue = $(element).css(`-webkit-box-shadow`);
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_innate_accent,
                vColorPickerInnateAccent
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_innate_accent,
                vColorPickerInnateAccent
              );
      ...
      .each(function (index, element) {
        ...
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : curValue.replace(
                mapDefaultColorsRGBA.t5e_alwaysprepared,
                vColorPickerAlwaysPrepared
              );
        ...
        newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
            ...
            : newValue.replace(
                mapDefaultColorsRGB.t5e_alwaysprepared,
                vColorPickerAlwaysPrepared
              );
    ...
    html
      .find('.tidy5e-sheet .grid-layout .item-list .item.alwaysprepared')
      .each(function (index, element) {
        const curValue = $(element).css(`-webkit-box-shadow`);
        let newValue =
          game.settings.get(CONSTANTS.MODULE_ID, 'colorScheme') === 'dark'
    ...
    html
      .find(
        '.tidy5e-sheet .grid-layout .item-list .item.alwaysprepared .item-image'
      )
      .each(function (index, element) {
        const curValue = $(element).css(`-webkit-box-shadow`);
        let newValue =
